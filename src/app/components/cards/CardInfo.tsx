  ...
  return (
    <article
      className={`my-5 mx-2  rounded-lg lg:min-w-80 ${
        extend ? "md:w-[360px] lg:w-[370px] text-lg " : "md:w-[360px] lg:w-[370px] bg-fundo"
      }`}
    >
      ...
      {showText && (
        <p className="text-justify text-textos px-4 font-sansModifi ">
          {textHidden}
        </p>
      )}
      {btn && showText ? (
        <div className="flex justify-center my-5">
          <button
            className="w-[80%] bg-principal text-textos2 rounded-xl shadow-lg
             hover:bg-principal3 hover:scale-105 
